...
import com.micro.booking.exception.ForbiddenException;
import com.micro.booking.exception.ResourceConflictException;
import com.micro.booking.exception.ResourceNotFoundException;
import com.micro.booking.exception.UnauthorizedException;
...
public class GlobalExceptionHandler {
    ...
    public Mono<ResponseEntity<Map<String, Object>>> handleWebFluxValidation(
    ...
    public ResponseEntity<String> handle503(ServiceUnavailableException ex) {
